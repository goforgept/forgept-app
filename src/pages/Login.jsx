    ...
    <div className="min-h-screen bg-[#0F1C2E] flex items-center justify-center">
      <div className="bg-[#1a2d45] p-8 rounded-xl w-full max-w-md">
        ...
        {!forgotMode ? (
          <>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                ...
                className="w-full text-[#8A9AB0] hover:text-white text-sm transition-colors text-center"
              >
          ...
          <>
            <p className="text-[#8A9AB0] mb-8">Enter your email and we will send you a reset link.</p>
            {error && <p className="text-red-400 mb-4 text-sm">{error}</p>}
            {resetSent ? (
